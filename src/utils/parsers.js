...
const PERCENT_FIELDS = new Set(['mbGpMargin', 'mmsGpMargin', 'penetration', 'coverage', 'marketGrowth', 'marketShare', 'mbGrowth', 'mmsGrowth', 'mbOutpaceMms', 'mmsOutpaceMarket', 'mbVsMmsGp']);
